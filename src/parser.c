...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym__value] = STATE(79),
    [sym_enum_variant] = STATE(79),
    [sym_array] = STATE(79),
    [sym_map] = STATE(79),
    [sym_struct] = STATE(79),
    [sym_unit_struct] = STATE(33),
    [sym_struct_name] = STATE(55),
    [sym__tuple_struct] = STATE(33),
    [sym__named_struct] = STATE(18),
    [sym__struct_body] = STATE(19),
    [sym_tuple] = STATE(79),
    [sym__literal] = STATE(79),
    [sym_negative] = STATE(79),
    [sym_string] = STATE(79),
    [sym_char] = STATE(79),
  ...
  [3] = {
    ...
    [sym__struct_body] = STATE(19),
    [sym_tuple] = STATE(62),
    [sym_struct_entry] = STATE(60),
    [sym__literal] = STATE(62),
    [sym_negative] = STATE(62),
    [sym_string] = STATE(62),
    [sym_char] = STATE(62),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_variant, 1),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_name, 1),
  ...
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 1, .production_id = 1),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__named_struct, 1, .production_id = 2),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 5),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 2),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_char, 4),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__struct_body, 4),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2),
  [93] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(24),
  [96] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(24),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple, 4),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 1),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__struct_body, 2),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map, 4),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map, 5),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean, 1),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_negative, 2),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 2),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct, 1),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 3),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_char, 2),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 4),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__named_struct, 2, .production_id = 3),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__tuple_struct, 2),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 3),
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple, 3),
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_char, 3),
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map, 3),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple, 5),
  ...
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__struct_body, 3),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__struct_body, 5),
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unit_struct, 1),
  ...
  [159] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2), SHIFT_REPEAT(12),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2),
  [164] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [166] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_map_repeat1, 2), SHIFT_REPEAT(10),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_map_repeat1, 2),
  ...
  [193] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__struct_body_repeat1, 2), SHIFT_REPEAT(71),
  [196] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__struct_body_repeat1, 2),
  ...
  [208] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_entry, 3),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_entry, 3),
